...
angular.module('ankiDecksApp')
  .controller('MainCtrl', function ($scope, $http) {
    ...
    $scope.gridOptions = { 
      data: 'decks',
      columnDefs: [
          {field:'title', displayName:'Title', cellTemplate: '<div class="ngCellText" ng-class="col.colIndex()"><span ng-cell-text><a href="{{row.getProperty(\'anki_package\')}}">{{row.getProperty(col.field)}}</a></span></div>'}, 
